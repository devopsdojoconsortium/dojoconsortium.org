...
Decompose stories using [Behavior Driven Development](/docs/work-decomposition/behavior-driven-development).
This not only helps with feature discovery and uncovering dependencies but also aids with [story slicing](/docs/work-decomposition/story-slicing) since each acceptance test
